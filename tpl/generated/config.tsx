...
<body className="border-top-wide border-primary d-flex flex-column">
    <div className="page">
        <div className="container container-tight py-4">
             ...
             <div className="card card-md" x-data="configForm()">
                 <div className="card-body">
                      <div x-show="message" :className="isError ? 'alert alert-danger' : 'alert alert-success'" x-text="message"></div>
                      <form @submit.prevent="submitConfig">
                          ...
                          <p className="text-muted">Enter the setup token displayed in the server console for today.</p>
                           <div className="mb-3">
                              ...
                              <input type="text" className="form-control" x-model="formData.admin_token" required/>
                          </div>
                          <hr className="my-4"/>
                          <h3 className="mb-3">Initial Project</h3>
                          <div className="mb-3">
                              <label className="form-label required">Project Name</label>
                              <input type="text" className="form-control" x-model="formData.project_name" required/>
                          </div>
                           <div className="mb-3">
                              <label className="form-label">Project Description</label>
                              <textarea className="form-control" x-model="formData.project_desc" rows="3"></textarea>
                          </div>
                           <div className="mb-3">
                              <label className="form-label required">Primary Host</label>
                              <input type="text" className="form-control" x-model="formData.primary_host" placeholder="e.g., myapp.com or localhost" required/>
                          ...
                          <div className="mb-3">
                              ...
                              <ul className="host-input-list">
                                  <template x-for="(host, index) in formData.redirect_hosts" :key="index">
                                      <li>
                                          <input type="text" className="form-control form-control-sm" x-model="formData.redirect_hosts[index]" placeholder="e.g., www.myapp.com"/>
                              ...
                              <button type="button" className="btn btn-sm btn-outline-secondary mt-2" @click="addHost('redirect')" x-show="formData.redirect_hosts.length < 20">
                          ...
                          <div className="mb-3">
                              ...
                              <ul className="host-input-list">
                                  <template x-for="(host, index) in formData.alias_hosts" :key="index">
                                      <li>
                                          <input type="text" className="form-control form-control-sm" x-model="formData.alias_hosts[index]" placeholder="e.g., oldapp.com"/>
                              ...
                              <button type="button" className="btn btn-sm btn-outline-secondary mt-2" @click="addHost('alias')" x-show="formData.alias_hosts.length < 20">
                          ...
                          <h3 className="mb-3">Initial Admin User</h3>
                           <div className="mb-3">
                              ...
                              <input type="email" className="form-control" x-model="formData.admin_email" required/>
                          </div>
                           <div className="mb-3">
                              <label className="form-label required">Admin Password</label>
                              <input type="password" className="form-control" x-model="formData.admin_password" required/>
                          </div>
